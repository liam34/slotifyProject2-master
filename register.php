			...
			<div id="inputContainer">
				...
				<form id="registerForm" action="register.php" method="POST">
					...
					<p>
						...
						<input id="email" name="email" type="email" placeholder="e.g. liamkent@gmail.com" value="<?php getInputValue('email') ?>" required>
					</p>

					<p>
						<label for="email2">Confirm email</label>
						<input id="email2" name="email2" type="email" placeholder="e.g. liamkent@gmail.com" value="<?php getInputValue('email2') ?>" required>
					</p>
